  ...
  return (
    <section className="card">
      ...
      <div className="mt-4 space-y-3 text-slate-300">
        <p>이 설문은 익명으로 진행되며, 이름·주민번호 등 직접 식별 정보는 수집하지 않습니다.</p>
        {open && (
          <div className="space-y-3">
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li><b>권리:</b> 언제든지 참여 철회 가능. 삭제/열람 요청: <a href="mailto:contact@example.com">contact@example.com</a></li>
              <li><b>의료 고지:</b> 본 설문은 의료 조언이 아니며, 응급 증상 시 119 또는 인근 응급실에 연락하세요.</li>
            </ul>
            <p className="text-xs text-slate-400">운영 환경에 맞게 이메일, 보관 기간, 보안 정책을 README 및 .env에서 수정하세요.</p>
          </div>
        )}
      </div>
    </section>
